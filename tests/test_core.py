...
class TestBaseModel(TestCase):
    ...
    def test_query(self):
        ...
        # m1 = TestSupModel(data={'id': 3, 'int1': 45, 'str1': 'example'})
        # m1.save()
        TestSupModel(data={'id': 3, 'int1': 45, 'str1': 'example'}).save()
        # m2 = TestSupModel(data={'id': 2, 'int1': 79, 'str1': 'sample'})
        # m2.save()
        m2 = TestSupModel(data={'id': 2, 'int1': 79, 'str1': 'sample'}).save()
        m2.save()
        qs = TestSupModel.query(TestSupModel.int1, TestSupModel.str1)
        ...
        self.assertEqual(qs.filter(int1=45)._sql, 'SELECT int1, str1 FROM testsupmodel WHERE int1 == "45"')
